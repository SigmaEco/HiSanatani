...
?>
<?php
    $sidebar_layout = get_theme_mod('religion_elementor_sidebar_layout_section', 'right');
            	...
            	if( is_active_sidebar( 'main-sidebar' )) {
					...
					<header class="page-header">
						...
						if ( have_posts() ) :
							...
							printf( '<h1 class="page-title">%1$s</h1>', esc_html__( 'Nothing Found', 'religion-elementor' ) );
						endif;
						?>
					</header><!-- .page-header -->
